...
ROBOTRACONTEURLITE_DECL int robotraconteurlite_buffer_init_scalar(struct robotraconteurlite_buffer* buffer, void* data,
                                                                  size_t len);

ROBOTRACONTEURLITE_DECL int robotraconteurlite_buffer_vec_init_scalar(struct robotraconteurlite_buffer_vec* buffer_vec,
...
ROBOTRACONTEURLITE_DECL int robotraconteurlite_buffer_vec_len(const struct robotraconteurlite_buffer_vec* source,
                                                              size_t* len);
...
ROBOTRACONTEURLITE_DECL int robotraconteurlite_buffer_copy_ex(
...
ROBOTRACONTEURLITE_DECL int robotraconteurlite_buffer_vec_copy_vec_ex(
...
/* double */
ROBOTRACONTEURLITE_DECL int robotraconteurlite_buffer_vec_copy_to_double_array(
...
ROBOTRACONTEURLITE_DECL int robotraconteurlite_buffer_vec_copy_from_double_array(
...
ROBOTRACONTEURLITE_DECL int robotraconteurlite_string_copy_to(const struct robotraconteurlite_string* source,
                                                              struct robotraconteurlite_string* dest);

ROBOTRACONTEURLITE_DECL int robotraconteurlite_string_shallow_copy_to(const struct robotraconteurlite_string* source,
                                                                      struct robotraconteurlite_string* dest);
