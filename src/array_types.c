    ...
    struct robotraconteurlite_array_double* dest, robotraconteurlite_size_t dest_pos, robotraconteurlite_size_t dest_count)
{
    return robotraconteurlite_buffer_vec_copy_to_mem(source_buf, source_buf_pos,
                                                    ...
                                                    (robotraconteurlite_u8*)dest->data, dest->len, dest_pos, sizeof(robotraconteurlite_double), dest_count);
}
    ...
    const struct robotraconteurlite_array_double* source, robotraconteurlite_size_t source_pos, robotraconteurlite_size_t source_count)
{
    return robotraconteurlite_buffer_vec_copy_from_mem(dest_buf, dest_buf_pos,
                                                    /* cppcheck-suppress invalidPointerCast */
                                                    (const robotraconteurlite_u8*)source->data, source->len, source_pos, sizeof(robotraconteurlite_double), source_count);
}
    ...
    const struct robotraconteurlite_buffer_vec* source_buf, robotraconteurlite_size_t source_buf_pos, robotraconteurlite_double* dest)
{
    return robotraconteurlite_buffer_vec_copy_to_mem(source_buf, source_buf_pos,
                                                    /* cppcheck-suppress invalidPointerCast */
                                                    (robotraconteurlite_u8*)dest, 1, 0, sizeof(robotraconteurlite_double), 1);
}
    ...
    struct robotraconteurlite_buffer_vec* dest_buf, robotraconteurlite_size_t dest_buf_pos, robotraconteurlite_double source)
{
    return robotraconteurlite_buffer_vec_copy_from_mem(dest_buf, dest_buf_pos,
                                                    /* cppcheck-suppress invalidPointerCast */
                                                    (const robotraconteurlite_u8*)&source, 1, 0, sizeof(robotraconteurlite_double), 1);
}
    ...
    struct robotraconteurlite_array_single* dest, robotraconteurlite_size_t dest_pos, robotraconteurlite_size_t dest_count)
{
    return robotraconteurlite_buffer_vec_copy_to_mem(source_buf, source_buf_pos,
                                                    /* cppcheck-suppress invalidPointerCast */
                                                    (robotraconteurlite_u8*)dest->data, dest->len, dest_pos, sizeof(float), dest_count);
}
    ...
    const struct robotraconteurlite_array_single* source, robotraconteurlite_size_t source_pos, robotraconteurlite_size_t source_count)
{
    return robotraconteurlite_buffer_vec_copy_from_mem(dest_buf, dest_buf_pos,
                                                    /* cppcheck-suppress invalidPointerCast */
                                                    (const robotraconteurlite_u8*)source->data, source->len, source_pos, sizeof(float), source_count);
}
    ...
    const struct robotraconteurlite_buffer_vec* source_buf, robotraconteurlite_size_t source_buf_pos, float* dest)
{
    return robotraconteurlite_buffer_vec_copy_to_mem(source_buf, source_buf_pos,
                                                    /* cppcheck-suppress invalidPointerCast */
                                                    (robotraconteurlite_u8*)dest, 1, 0, sizeof(float), 1);
}
    ...
    struct robotraconteurlite_buffer_vec* dest_buf, robotraconteurlite_size_t dest_buf_pos, float source)
{
    return robotraconteurlite_buffer_vec_copy_from_mem(dest_buf, dest_buf_pos,
                                                    /* cppcheck-suppress invalidPointerCast */
                                                    (const robotraconteurlite_u8*)&source, 1, 0, sizeof(float), 1);
}
...
{
    return robotraconteurlite_buffer_vec_copy_to_mem(source_buf, source_buf_pos,
                                                    (robotraconteurlite_u8*)dest->data, dest->len, dest_pos, sizeof(robotraconteurlite_i8), dest_count);
}
...
{
    return robotraconteurlite_buffer_vec_copy_from_mem(dest_buf, dest_buf_pos,
                                                    (const robotraconteurlite_u8*)source->data, source->len, source_pos, sizeof(robotraconteurlite_i8), source_count);
}
...
{
    return robotraconteurlite_buffer_vec_copy_to_mem(source_buf, source_buf_pos,
                                                    (robotraconteurlite_u8*)dest, 1, 0, sizeof(robotraconteurlite_i8), 1);
}
...
{
    return robotraconteurlite_buffer_vec_copy_from_mem(dest_buf, dest_buf_pos,
                                                    (const robotraconteurlite_u8*)&source, 1, 0, sizeof(robotraconteurlite_i8), 1);
}
...
{
    return robotraconteurlite_buffer_vec_copy_to_mem(source_buf, source_buf_pos,
                                                    (robotraconteurlite_u8*)dest->data, dest->len, dest_pos, sizeof(robotraconteurlite_u8), dest_count);
}
...
{
    return robotraconteurlite_buffer_vec_copy_from_mem(dest_buf, dest_buf_pos,
                                                    (const robotraconteurlite_u8*)source->data, source->len, source_pos, sizeof(robotraconteurlite_u8), source_count);
}
...
{
    return robotraconteurlite_buffer_vec_copy_to_mem(source_buf, source_buf_pos,
                                                    (robotraconteurlite_u8*)dest, 1, 0, sizeof(robotraconteurlite_u8), 1);
}
...
{
    return robotraconteurlite_buffer_vec_copy_from_mem(dest_buf, dest_buf_pos,
                                                    (const robotraconteurlite_u8*)&source, 1, 0, sizeof(robotraconteurlite_u8), 1);
}
...
{
    return robotraconteurlite_buffer_vec_copy_to_mem(source_buf, source_buf_pos,
                                                    (robotraconteurlite_u8*)dest->data, dest->len, dest_pos, sizeof(robotraconteurlite_i16), dest_count);
}
...
{
    return robotraconteurlite_buffer_vec_copy_from_mem(dest_buf, dest_buf_pos,
                                                    (const robotraconteurlite_u8*)source->data, source->len, source_pos, sizeof(robotraconteurlite_i16), source_count);
}
...
{
    return robotraconteurlite_buffer_vec_copy_to_mem(source_buf, source_buf_pos,
                                                    (robotraconteurlite_u8*)dest, 1, 0, sizeof(robotraconteurlite_i16), 1);
}
...
{
    return robotraconteurlite_buffer_vec_copy_from_mem(dest_buf, dest_buf_pos,
                                                    (const robotraconteurlite_u8*)&source, 1, 0, sizeof(robotraconteurlite_i16), 1);
}
...
{
    return robotraconteurlite_buffer_vec_copy_to_mem(source_buf, source_buf_pos,
                                                    (robotraconteurlite_u8*)dest->data, dest->len, dest_pos, sizeof(robotraconteurlite_u16), dest_count);
}
...
{
    return robotraconteurlite_buffer_vec_copy_from_mem(dest_buf, dest_buf_pos,
                                                    (const robotraconteurlite_u8*)source->data, source->len, source_pos, sizeof(robotraconteurlite_u16), source_count);
}
...
{
    return robotraconteurlite_buffer_vec_copy_to_mem(source_buf, source_buf_pos,
                                                    (robotraconteurlite_u8*)dest, 1, 0, sizeof(robotraconteurlite_u16), 1);
}
...
{
    return robotraconteurlite_buffer_vec_copy_from_mem(dest_buf, dest_buf_pos,
                                                    (const robotraconteurlite_u8*)&source, 1, 0, sizeof(robotraconteurlite_u16), 1);
}
...
{
    return robotraconteurlite_buffer_vec_copy_to_mem(source_buf, source_buf_pos,
                                                    (robotraconteurlite_u8*)dest->data, dest->len, dest_pos, sizeof(robotraconteurlite_i32), dest_count);
}
...
{
    return robotraconteurlite_buffer_vec_copy_from_mem(dest_buf, dest_buf_pos,
                                                    (const robotraconteurlite_u8*)source->data, source->len, source_pos, sizeof(robotraconteurlite_i32), source_count);
}
...
{
    return robotraconteurlite_buffer_vec_copy_to_mem(source_buf, source_buf_pos,
                                                    (robotraconteurlite_u8*)dest, 1, 0, sizeof(robotraconteurlite_i32), 1);
}
...
{
    return robotraconteurlite_buffer_vec_copy_from_mem(dest_buf, dest_buf_pos,
                                                    (const robotraconteurlite_u8*)&source, 1, 0, sizeof(robotraconteurlite_i32), 1);
}
...
{
    return robotraconteurlite_buffer_vec_copy_to_mem(source_buf, source_buf_pos,
                                                    (robotraconteurlite_u8*)dest->data, dest->len, dest_pos, sizeof(robotraconteurlite_u32), dest_count);
}
...
{
    return robotraconteurlite_buffer_vec_copy_from_mem(dest_buf, dest_buf_pos,
                                                    (const robotraconteurlite_u8*)source->data, source->len, source_pos, sizeof(robotraconteurlite_u32), source_count);
}
...
{
    return robotraconteurlite_buffer_vec_copy_to_mem(source_buf, source_buf_pos,
                                                    (robotraconteurlite_u8*)dest, 1, 0, sizeof(robotraconteurlite_u32), 1);
}
...
{
    return robotraconteurlite_buffer_vec_copy_from_mem(dest_buf, dest_buf_pos,
                                                    (const robotraconteurlite_u8*)&source, 1, 0, sizeof(robotraconteurlite_u32), 1);
}
...
{
    return robotraconteurlite_buffer_vec_copy_to_mem(source_buf, source_buf_pos,
                                                    (robotraconteurlite_u8*)dest->data, dest->len, dest_pos, sizeof(robotraconteurlite_i64), dest_count);
}
...
{
    return robotraconteurlite_buffer_vec_copy_from_mem(dest_buf, dest_buf_pos,
                                                    (const robotraconteurlite_u8*)source->data, source->len, source_pos, sizeof(robotraconteurlite_i64), source_count);
}
...
{
    return robotraconteurlite_buffer_vec_copy_to_mem(source_buf, source_buf_pos,
                                                    (robotraconteurlite_u8*)dest, 1, 0, sizeof(robotraconteurlite_i64), 1);
}
...
{
    return robotraconteurlite_buffer_vec_copy_from_mem(dest_buf, dest_buf_pos,
                                                    (const robotraconteurlite_u8*)&source, 1, 0, sizeof(robotraconteurlite_i64), 1);
}
...
{
    return robotraconteurlite_buffer_vec_copy_to_mem(source_buf, source_buf_pos,
                                                    (robotraconteurlite_u8*)dest->data, dest->len, dest_pos, sizeof(robotraconteurlite_u64), dest_count);
}
...
{
    return robotraconteurlite_buffer_vec_copy_from_mem(dest_buf, dest_buf_pos,
                                                    (const robotraconteurlite_u8*)source->data, source->len, source_pos, sizeof(robotraconteurlite_u64), source_count);
}
...
{
    return robotraconteurlite_buffer_vec_copy_to_mem(source_buf, source_buf_pos,
                                                    (robotraconteurlite_u8*)dest, 1, 0, sizeof(robotraconteurlite_u64), 1);
}
...
{
    return robotraconteurlite_buffer_vec_copy_from_mem(dest_buf, dest_buf_pos,
                                                    (const robotraconteurlite_u8*)&source, 1, 0, sizeof(robotraconteurlite_u64), 1);
}
...
{
    return robotraconteurlite_buffer_vec_copy_to_mem(source_buf, source_buf_pos,
                                                    (robotraconteurlite_u8*)dest->data, dest->len, dest_pos, sizeof(struct robotraconteurlite_cdouble), dest_count);
}
...
{
    return robotraconteurlite_buffer_vec_copy_from_mem(dest_buf, dest_buf_pos,
                                                    (const robotraconteurlite_u8*)source->data, source->len, source_pos, sizeof(struct robotraconteurlite_cdouble), source_count);
}
...
{
    return robotraconteurlite_buffer_vec_copy_to_mem(source_buf, source_buf_pos,
                                                    (robotraconteurlite_u8*)dest, 1, 0, sizeof(struct robotraconteurlite_cdouble), 1);
}
...
{
    return robotraconteurlite_buffer_vec_copy_from_mem(dest_buf, dest_buf_pos,
                                                    (const robotraconteurlite_u8*)&source, 1, 0, sizeof(struct robotraconteurlite_cdouble), 1);
}
...
{
    return robotraconteurlite_buffer_vec_copy_to_mem(source_buf, source_buf_pos,
                                                    (robotraconteurlite_u8*)dest->data, dest->len, dest_pos, sizeof(struct robotraconteurlite_csingle), dest_count);
}
...
{
    return robotraconteurlite_buffer_vec_copy_from_mem(dest_buf, dest_buf_pos,
                                                    (const robotraconteurlite_u8*)source->data, source->len, source_pos, sizeof(struct robotraconteurlite_csingle), source_count);
}
...
{
    return robotraconteurlite_buffer_vec_copy_to_mem(source_buf, source_buf_pos,
                                                    (robotraconteurlite_u8*)dest, 1, 0, sizeof(struct robotraconteurlite_csingle), 1);
}
...
{
    return robotraconteurlite_buffer_vec_copy_from_mem(dest_buf, dest_buf_pos,
                                                    (const robotraconteurlite_u8*)&source, 1, 0, sizeof(struct robotraconteurlite_csingle), 1);
}
...
{
    return robotraconteurlite_buffer_vec_copy_to_mem(source_buf, source_buf_pos,
                                                    (robotraconteurlite_u8*)dest->data, dest->len, dest_pos, sizeof(struct robotraconteurlite_bool), dest_count);
}
...
{
    return robotraconteurlite_buffer_vec_copy_from_mem(dest_buf, dest_buf_pos,
                                                    (const robotraconteurlite_u8*)source->data, source->len, source_pos, sizeof(struct robotraconteurlite_bool), source_count);
}
...
{
    return robotraconteurlite_buffer_vec_copy_to_mem(source_buf, source_buf_pos,
                                                    (robotraconteurlite_u8*)dest, 1, 0, sizeof(struct robotraconteurlite_bool), 1);
}
...
{
    return robotraconteurlite_buffer_vec_copy_from_mem(dest_buf, dest_buf_pos,
                                                    (const robotraconteurlite_u8*)&source, 1, 0, sizeof(struct robotraconteurlite_bool), 1);
}
