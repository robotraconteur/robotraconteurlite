...
ROBOTRACONTEURLITE_DECL int robotraconteurlite_buffer_copy(const struct robotraconteurlite_buffer* source, 
	size_t source_pos, const struct robotraconteurlite_buffer* dest, size_t dest_pos, size_t count);

ROBOTRACONTEURLITE_DECL int robotraconteurlite_buffer_vec_copy_vec(const struct robotraconteurlite_buffer_vec* source,
	size_t source_pos, const struct robotraconteurlite_buffer_vec* dest, size_t dest_pos, size_t count);

ROBOTRACONTEURLITE_DECL int robotraconteurlite_buffer_copy_ex(const struct robotraconteurlite_buffer* source,
...
ROBOTRACONTEURLITE_DECL int robotraconteurlite_buffer_vec_copy_vec_ex(const struct robotraconteurlite_buffer_vec* source,
	size_t source_pos, size_t source_elem_size, size_t source_count, const struct robotraconteurlite_buffer_vec* dest,
	size_t dest_pos, size_t dest_elem_size, size_t dest_count);

/* double */
ROBOTRACONTEURLITE_DECL int robotraconteurlite_buffer_vec_copy_to_double_array(const struct robotraconteurlite_buffer_vec* source_buf,
	size_t source_buf_pos, const struct robotraconteurlite_array_double* dest, size_t dest_pos, size_t dest_count);

ROBOTRACONTEURLITE_DECL int robotraconteurlite_buffer_vec_copy_from_double_array(const struct robotraconteurlite_buffer_vec* dest_buf,
	size_t dest_buf_pos, const struct robotraconteurlite_array_double* source, size_t source_pos, size_t source_count);

ROBOTRACONTEURLITE_DECL int robotraconteurlite_buffer_vec_copy_to_double(const struct robotraconteurlite_buffer_vec* source_buf,
	size_t source_buf_pos, double* dest);

ROBOTRACONTEURLITE_DECL int robotraconteurlite_buffer_vec_copy_from_double(const struct robotraconteurlite_buffer_vec* dest_buf,
	size_t dest_buf_pos, double source);


/* single */
ROBOTRACONTEURLITE_DECL int robotraconteurlite_buffer_vec_copy_to_single_array(const struct robotraconteurlite_buffer_vec* source_buf,
	size_t source_buf_pos, const struct robotraconteurlite_array_single* dest, size_t dest_pos, size_t dest_count);

ROBOTRACONTEURLITE_DECL int robotraconteurlite_buffer_vec_copy_from_single_array(const struct robotraconteurlite_buffer_vec* dest_buf,
	size_t dest_buf_pos, const struct robotraconteurlite_array_single* source, size_t source_pos, size_t source_count);

ROBOTRACONTEURLITE_DECL int robotraconteurlite_buffer_vec_copy_to_single(const struct robotraconteurlite_buffer_vec* source_buf,
	size_t source_buf_pos, float* dest);

ROBOTRACONTEURLITE_DECL int robotraconteurlite_buffer_vec_copy_from_single(const struct robotraconteurlite_buffer_vec* dest_buf,
	size_t dest_buf_pos, float source);


/* int8 */
ROBOTRACONTEURLITE_DECL int robotraconteurlite_buffer_vec_copy_to_int8_array(const struct robotraconteurlite_buffer_vec* source_buf,
	size_t source_buf_pos, const struct robotraconteurlite_array_int8* dest, size_t dest_pos, size_t dest_count);

ROBOTRACONTEURLITE_DECL int robotraconteurlite_buffer_vec_copy_from_int8_array(const struct robotraconteurlite_buffer_vec* dest_buf,
	size_t dest_buf_pos, const struct robotraconteurlite_array_int8* source, size_t source_pos, size_t source_count);

ROBOTRACONTEURLITE_DECL int robotraconteurlite_buffer_vec_copy_to_int8(const struct robotraconteurlite_buffer_vec* source_buf,
	size_t source_buf_pos, int8_t* dest);

ROBOTRACONTEURLITE_DECL int robotraconteurlite_buffer_vec_copy_from_int8(const struct robotraconteurlite_buffer_vec* dest_buf,
	size_t dest_buf_pos, int8_t source);


/* uint8 */
ROBOTRACONTEURLITE_DECL int robotraconteurlite_buffer_vec_copy_to_uint8_array(const struct robotraconteurlite_buffer_vec* source_buf,
	size_t source_buf_pos, const struct robotraconteurlite_array_uint8* dest, size_t dest_pos, size_t dest_count);

ROBOTRACONTEURLITE_DECL int robotraconteurlite_buffer_vec_copy_from_uint8_array(const struct robotraconteurlite_buffer_vec* dest_buf,
	size_t dest_buf_pos, const struct robotraconteurlite_array_uint8* source, size_t source_pos, size_t source_count);

ROBOTRACONTEURLITE_DECL int robotraconteurlite_buffer_vec_copy_to_uint8(const struct robotraconteurlite_buffer_vec* source_buf,
	size_t source_buf_pos, uint8_t* dest);

ROBOTRACONTEURLITE_DECL int robotraconteurlite_buffer_vec_copy_from_uint8(const struct robotraconteurlite_buffer_vec* dest_buf,
	size_t dest_buf_pos, uint8_t source);


/* int16 */
ROBOTRACONTEURLITE_DECL int robotraconteurlite_buffer_vec_copy_to_int16_array(const struct robotraconteurlite_buffer_vec* source_buf,
	size_t source_buf_pos, const struct robotraconteurlite_array_int16* dest, size_t dest_pos, size_t dest_count);

ROBOTRACONTEURLITE_DECL int robotraconteurlite_buffer_vec_copy_from_int16_array(const struct robotraconteurlite_buffer_vec* dest_buf,
	size_t dest_buf_pos, const struct robotraconteurlite_array_int16* source, size_t source_pos, size_t source_count);

ROBOTRACONTEURLITE_DECL int robotraconteurlite_buffer_vec_copy_to_int16(const struct robotraconteurlite_buffer_vec* source_buf,
	size_t source_buf_pos, int16_t* dest);

ROBOTRACONTEURLITE_DECL int robotraconteurlite_buffer_vec_copy_from_int16(const struct robotraconteurlite_buffer_vec* dest_buf,
	size_t dest_buf_pos, int16_t source);


/* uint16 */
ROBOTRACONTEURLITE_DECL int robotraconteurlite_buffer_vec_copy_to_uint16_array(const struct robotraconteurlite_buffer_vec* source_buf,
	size_t source_buf_pos, const struct robotraconteurlite_array_uint16* dest, size_t dest_pos, size_t dest_count);

ROBOTRACONTEURLITE_DECL int robotraconteurlite_buffer_vec_copy_from_uint16_array(const struct robotraconteurlite_buffer_vec* dest_buf,
	size_t dest_buf_pos, const struct robotraconteurlite_array_uint16* source, size_t source_pos, size_t source_count);

ROBOTRACONTEURLITE_DECL int robotraconteurlite_buffer_vec_copy_to_uint16(const struct robotraconteurlite_buffer_vec* source_buf,
	size_t source_buf_pos, uint16_t* dest);

ROBOTRACONTEURLITE_DECL int robotraconteurlite_buffer_vec_copy_from_uint16(const struct robotraconteurlite_buffer_vec* dest_buf,
	size_t dest_buf_pos, uint16_t source);


/* int32 */
ROBOTRACONTEURLITE_DECL int robotraconteurlite_buffer_vec_copy_to_int32_array(const struct robotraconteurlite_buffer_vec* source_buf,
	size_t source_buf_pos, const struct robotraconteurlite_array_int32* dest, size_t dest_pos, size_t dest_count);

ROBOTRACONTEURLITE_DECL int robotraconteurlite_buffer_vec_copy_from_int32_array(const struct robotraconteurlite_buffer_vec* dest_buf,
	size_t dest_buf_pos, const struct robotraconteurlite_array_int32* source, size_t source_pos, size_t source_count);

ROBOTRACONTEURLITE_DECL int robotraconteurlite_buffer_vec_copy_to_int32(const struct robotraconteurlite_buffer_vec* source_buf,
	size_t source_buf_pos, int32_t* dest);

ROBOTRACONTEURLITE_DECL int robotraconteurlite_buffer_vec_copy_from_int32(const struct robotraconteurlite_buffer_vec* dest_buf,
	size_t dest_buf_pos, int32_t source);


/* uint32 */
ROBOTRACONTEURLITE_DECL int robotraconteurlite_buffer_vec_copy_to_uint32_array(const struct robotraconteurlite_buffer_vec* source_buf,
	size_t source_buf_pos, const struct robotraconteurlite_array_uint32* dest, size_t dest_pos, size_t dest_count);

ROBOTRACONTEURLITE_DECL int robotraconteurlite_buffer_vec_copy_from_uint32_array(const struct robotraconteurlite_buffer_vec* dest_buf,
	size_t dest_buf_pos, const struct robotraconteurlite_array_uint32* source, size_t source_pos, size_t source_count);

ROBOTRACONTEURLITE_DECL int robotraconteurlite_buffer_vec_copy_to_uint32(const struct robotraconteurlite_buffer_vec* source_buf,
	size_t source_buf_pos, uint32_t* dest);

ROBOTRACONTEURLITE_DECL int robotraconteurlite_buffer_vec_copy_from_uint32(const struct robotraconteurlite_buffer_vec* dest_buf,
	size_t dest_buf_pos, uint32_t source);


/* int64 */
ROBOTRACONTEURLITE_DECL int robotraconteurlite_buffer_vec_copy_to_int64_array(const struct robotraconteurlite_buffer_vec* source_buf,
	size_t source_buf_pos, const struct robotraconteurlite_array_int64* dest, size_t dest_pos, size_t dest_count);

ROBOTRACONTEURLITE_DECL int robotraconteurlite_buffer_vec_copy_from_int64_array(const struct robotraconteurlite_buffer_vec* dest_buf,
	size_t dest_buf_pos, const struct robotraconteurlite_array_int64* source, size_t source_pos, size_t source_count);

ROBOTRACONTEURLITE_DECL int robotraconteurlite_buffer_vec_copy_to_int64(const struct robotraconteurlite_buffer_vec* source_buf,
	size_t source_buf_pos, int64_t* dest);

ROBOTRACONTEURLITE_DECL int robotraconteurlite_buffer_vec_copy_from_int64(const struct robotraconteurlite_buffer_vec* dest_buf,
	size_t dest_buf_pos, int64_t source);


/* uint64 */
ROBOTRACONTEURLITE_DECL int robotraconteurlite_buffer_vec_copy_to_uint64_array(const struct robotraconteurlite_buffer_vec* source_buf,
	size_t source_buf_pos, const struct robotraconteurlite_array_uint64* dest, size_t dest_pos, size_t dest_count);

ROBOTRACONTEURLITE_DECL int robotraconteurlite_buffer_vec_copy_from_uint64_array(const struct robotraconteurlite_buffer_vec* dest_buf,
	size_t dest_buf_pos, const struct robotraconteurlite_array_uint64* source, size_t source_pos, size_t source_count);

ROBOTRACONTEURLITE_DECL int robotraconteurlite_buffer_vec_copy_to_uint64(const struct robotraconteurlite_buffer_vec* source_buf,
	size_t source_buf_pos, uint64_t* dest);

ROBOTRACONTEURLITE_DECL int robotraconteurlite_buffer_vec_copy_from_uint64(const struct robotraconteurlite_buffer_vec* dest_buf,
	size_t dest_buf_pos, uint64_t source);


/* cdouble */
ROBOTRACONTEURLITE_DECL int robotraconteurlite_buffer_vec_copy_to_cdouble_array(const struct robotraconteurlite_buffer_vec* source_buf,
	size_t source_buf_pos, const struct robotraconteurlite_array_cdouble* dest, size_t dest_pos, size_t dest_count);

ROBOTRACONTEURLITE_DECL int robotraconteurlite_buffer_vec_copy_from_cdouble_array(const struct robotraconteurlite_buffer_vec* dest_buf,
	size_t dest_buf_pos, const struct robotraconteurlite_array_cdouble* source, size_t source_pos, size_t source_count);

ROBOTRACONTEURLITE_DECL int robotraconteurlite_buffer_vec_copy_to_cdouble(const struct robotraconteurlite_buffer_vec* source_buf,
	size_t source_buf_pos, struct robotraconteurlite_cdouble* dest);

ROBOTRACONTEURLITE_DECL int robotraconteurlite_buffer_vec_copy_from_cdouble(const struct robotraconteurlite_buffer_vec* dest_buf,
	size_t dest_buf_pos, struct robotraconteurlite_cdouble source);


/* csingle */
ROBOTRACONTEURLITE_DECL int robotraconteurlite_buffer_vec_copy_to_csingle_array(const struct robotraconteurlite_buffer_vec* source_buf,
	size_t source_buf_pos, const struct robotraconteurlite_array_csingle* dest, size_t dest_pos, size_t dest_count);

ROBOTRACONTEURLITE_DECL int robotraconteurlite_buffer_vec_copy_from_csingle_array(const struct robotraconteurlite_buffer_vec* dest_buf,
	size_t dest_buf_pos, const struct robotraconteurlite_array_csingle* source, size_t source_pos, size_t source_count);

ROBOTRACONTEURLITE_DECL int robotraconteurlite_buffer_vec_copy_to_csingle(const struct robotraconteurlite_buffer_vec* source_buf,
	size_t source_buf_pos, struct robotraconteurlite_csingle* dest);

ROBOTRACONTEURLITE_DECL int robotraconteurlite_buffer_vec_copy_from_csingle(const struct robotraconteurlite_buffer_vec* dest_buf,
	size_t dest_buf_pos, struct robotraconteurlite_csingle source);


/* struct robotraconteurlite_bool */
ROBOTRACONTEURLITE_DECL int robotraconteurlite_buffer_vec_copy_to_bool_array(const struct robotraconteurlite_buffer_vec* source_buf,
	size_t source_buf_pos, const struct robotraconteurlite_array_bool* dest, size_t dest_pos, size_t dest_count);

ROBOTRACONTEURLITE_DECL int robotraconteurlite_buffer_vec_copy_from_bool_array(const struct robotraconteurlite_buffer_vec* dest_buf,
	size_t dest_buf_pos, const struct robotraconteurlite_array_bool* source, size_t source_pos, size_t source_count);


ROBOTRACONTEURLITE_DECL int robotraconteurlite_buffer_vec_copy_to_bool(const struct robotraconteurlite_buffer_vec* source_buf,
	size_t source_buf_pos, struct robotraconteurlite_bool* dest);

ROBOTRACONTEURLITE_DECL int robotraconteurlite_buffer_vec_copy_from_bool(const struct robotraconteurlite_buffer_vec* dest_buf,
	size_t dest_buf_pos, struct robotraconteurlite_bool source);

/* string */
ROBOTRACONTEURLITE_DECL int robotraconteurlite_buffer_vec_copy_to_string(const struct robotraconteurlite_buffer_vec* source_buf,
	size_t source_buf_pos, const struct robotraconteurlite_string* dest, size_t dest_pos, size_t dest_count);

ROBOTRACONTEURLITE_DECL int robotraconteurlite_buffer_vec_copy_from_string(const struct robotraconteurlite_buffer_vec* dest_buf,
